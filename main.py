...
import sys
this games for you. Happy birthday to you, I hope to see you  (Gia Linh) (Linh cute)
...
money_received = '0'  # Keeps track of monex`y user has secured
...
y = [("Welcome to who wants to be a millionaire, Geography edition!"
      ), "I’m your host, QUANG NGHIA", "What is your name?:"]  # asks for users name
...
def easteregg(yotus):
    if yotus == 'pawel':
        return " Please mark our assignment well♥" \
               " Are you ready,GiaLinh ?!"
    else:
        return 'Are you ready,GiaLinh ?!'
...
print("\033[94m" + "Congratulations " + name + "!!! You are now a *virtual* Millionaire~~ Thank you for playing :), ANH MONG GIA LINH SE CANG NGAY TRUONG THANH HANH PHUC, MAI BEN CANH EM")
